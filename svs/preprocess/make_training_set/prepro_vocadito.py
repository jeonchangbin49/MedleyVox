...
path_list = glob.glob("/path/to/data/vocadito/Audio/*.wav")

os.makedirs(
    f"/path/to/data/{args.samplerate_folder_name}/vocadito",
    exist_ok=True,
)
for path in tqdm.tqdm(path_list):
    ...
    sf.write(
        f"/path/to/data/{args.samplerate_folder_name}/vocadito/{basename}",
        wav,
        args.sample_rate,
        subtype="PCM_16",
    )
